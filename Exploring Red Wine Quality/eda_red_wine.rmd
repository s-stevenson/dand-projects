...
patterns that characterize good or bad wines.
...
ggplot(wine, aes(alcohol)) + 
  geom_histogram(binwidth = .5, fill="#993333", colour="black") + 
...
ggplot(wine, aes(density)) + geom_freqpoly(binwidth = .001, aes(color = quality))

ggplot(wine, aes(residual.sugar)) + geom_freqpoly(aes(color = quality))

ggplot(wine, aes(chlorides)) + geom_freqpoly(aes(color = quality))
