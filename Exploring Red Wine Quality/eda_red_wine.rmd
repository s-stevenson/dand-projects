...
# create new factor variable classifying wines as good or mediocre based on
# quality score
wine$quality <- as.factor(ifelse(wine$rating <= 5, 'mediocre', 'good'))
...
ggplot(wine, aes(rating)) +
  geom_histogram(binwidth = 1, fill="#993333", colour="black") + 
