...
ggplot(wine_quality, aes(quality)) +
  geom_histogram(binwidth = 1, fill="#993333", colour="black") + 
  scale_x_continuous(breaks = seq(0, 10, 1), limits = c(0, 10)) + 
  scale_y_continuous(breaks = seq(0, 700, 100)) +
  xlab("median quality score") + 
  ggtitle("Distribution of Wine Quality") + theme_grey()

ggplot(wine_quality, aes(alcohol)) + geom_histogram(binwidth = .5, fill="#993333", colour="black") + scale_x_continuous(breaks = seq(0, 20, .5)) + xlab("alcohol (% by volume)") + ggtitle("Distribution of Alcohol Content")

citric <- ggplot(wine_quality, aes(citric.acid)) + geom_freqpoly()
volatile <- ggplot(wine_quality, aes(volatile.acidity)) + geom_freqpoly()
fixed <- ggplot(wine_quality, aes(fixed.acidity)) + geom_freqpoly()
pH <- ggplot(wine_quality, aes(pH)) + geom_freqpoly()
grid.arrange(citric, volatile, fixed, pH, ncol = 2)

ggplot(wine_quality, aes(density)) + geom_freqpoly(binwidth = .001)
```
